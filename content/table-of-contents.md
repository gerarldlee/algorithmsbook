...
The book is organized into Parts, Chapters, and Topics. This index lists the chapter-level path through the book.

## Essentials

- [Prerequisites](docs/00-essentials/01-prerequisites.md)
- [How Memory Works](docs/00-essentials/02-how-memory-works.md)
- [Growth of Algorithm](docs/00-essentials/03-growth-of-algorithm.md)
- [Maths](docs/00-essentials/04-maths.md)
- [Concepts](docs/00-essentials/05-concepts.md)
- [Memory Works (Templates)](docs/00-essentials/06-memory-works-templates.md)
- [Mindmap](docs/00-essentials/07-mindmap.md)
- [References](docs/00-essentials/08-references.md)
...
- [Chapter 7: Asynchronous Messaging & Pub/Sub Systems](docs/03-messaging/01-messaging/)
- [Chapter 7A: Data Engineering & Stream Processing](docs/03-messaging/03-data-engineering-stream-processing/)
- [Chapter 8: Real-Time Communication & Notification Systems](docs/03-messaging/02-realtime/)

## Part IV: Distributed Systems & Database Architecture

- [Chapter 9: Distributed Systems Principles, Consensus & Decentralized Ledger Technology](docs/04-distributed-systems/01-consensus/)
- [Chapter 10: Database Engineering, Replication & Scaling](docs/04-distributed-systems/02-databases/)

## Part V: Cloud Architecture, Operating Systems & DevOps Engineering

- [Chapter 11: Cloud Primitives, Edge Systems & IoT Engineering](docs/05-cloud-devops/01-cloud-primitives/)
- [Chapter 12: Containerization, Orchestration & CI/CD Pipelines](docs/05-cloud-devops/02-containers-cicd/)
- [Chapter 12A: Operating Systems & Kernel Mechanics](docs/05-cloud-devops/03-operating-systems-kernel-mechanics/)
...
- [Chapter 21: Search, Ranking & Recommendation Systems](docs/07-part-vii/06-search-ranking/)

## Part VIII: Web3 Security, Multi-Tenancy & Embedded Finance

- [Part VIII: Web3 Security, Multi-Tenancy & Embedded Finance](docs/08-web3-embedded-finance/)
- [Chapter 22: Crypto Custody, Privacy Cryptography & Web3 Security](docs/08-web3-embedded-finance/01-crypto-custody-security/)
- [Chapter 23: Multi-Tenant SaaS & Licensing](docs/08-web3-embedded-finance/02-multitenant-licensing/)
