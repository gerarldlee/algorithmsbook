---
title: "Chapter 1: Linear Data Structures & Memory Models"
weight: 1
---

The simplest data structures that everything else builds on: arrays, linked lists, stacks, queues, deques, hash tables, and bit-level structures.
